...
ADAPTER_DIR=${ADAPTER_DIR:-outputs/yesno_scorer/qwen25_1p5b_lora_full/final_adapter}
...
python scripts/eval/evaluate_yesno_scorer_ranking.py \
  ...
  --out-json data/processed/scorer_baseline/yesno_scorer_full_ranking.json \
  --out-md reports/yesno_scorer_full_ranking.md \
  --batch-size 8 \
  --max-seq-length 2048 \
