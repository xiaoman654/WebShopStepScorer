...
python scripts/train/train_yesno_lora.py \
  ...
  --train-file data/processed/yesno_scorer_sft_v2_hardneg/train.jsonl \
  --valid-file data/processed/yesno_scorer_sft_v2_hardneg/valid.jsonl \
  --output-dir outputs/yesno_scorer/qwen25_1p5b_lora_v2_hardneg \
